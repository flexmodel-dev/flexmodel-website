...
- **流程编排**: 流程定义、部署、实例管理及执行引擎
- **任务调度**: 触发器配置与作业执行管理
- **对象存储**: Bucket 与文件的增删改查操作
- **身份认证**: 用户、角色、资源权限管理，OIDC/LDAP 身份提供商
- **MCP Server**: AI 工具集成，15 个 MCP Tools 开放核心能力
- **边缘函数**: 函数创建、部署、调用与模板管理（实验性）
...
- [模型 Schema](./definition/model-schema.md) - 数据模型定义规范
- [查询条件](./definition/condition.md) - 查询条件语法说明
